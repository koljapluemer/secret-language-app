...
import { getRandomVocabFormSentenceTask } from '@/tasks/task-vocab-form-sentence/getRandom';
...
import { getRandomAddImageToVocabTask } from '@/tasks/task-add-image-to-vocab/getRandom';
import { getRandomVocabChooseImageBySoundTask } from '@/tasks/task-vocab-choose-image-by-sound/getRandom';
